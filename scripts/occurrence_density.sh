...
java -Xmx8G -cp ${JAVA_CLASSPATH} OccurrenceDensityLayerGenerator 0.1 $OUTPUTDIR/cell-occurrence-counts-0.1-degree.txt $OUTPUTDIR odensity 1>> $OUTPUTDIR/build.log 2>&1
...
java -Xmx8G -cp ${JAVA_CLASSPATH} GridLegend $PTH/ready/diva/odensity $PTH/test/odensity 8 1 1>> $OUTPUTDIR/build.log 2>&1
